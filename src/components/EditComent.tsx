...
export const EditComment = ({  comment, userId, setEdit}: Props) => {
    
    const {updateComment} = useContext(RestaurantContext)
  ...
  return (
    <div>
      ...
      className="border border-black rounded-3xl p-4 flex flex-col gap-6 h-fit bg-white w-[30vw]"
    >
      ...
      <div className="flex justify-between items-center">
        ...
        {/* <span className="text-xl text-black">{errorMessage}</span> */}
            ...
            <form method="dialog">
              ...
              <button  className="border py-3 px-8 w-fit rounded-3xl font-semibold capitalize border-black text-black ">Cerrar</button>
            </form>
      </div>
    </form>
      </dialog>
